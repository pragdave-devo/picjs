...
export const keywords: readonly PikWord[] = [
  ...
  { zWord: "alter",       nChar: 5,  eType: TokenType.T_ALTER,     eCode: 0,         eEdge: 0        },
  ...
  { zWord: "bounce",      nChar: 6,  eType: TokenType.T_BOUNCE,    eCode: 0,         eEdge: 0        },
  { zWord: "c",           nChar: 1,  eType: TokenType.T_EDGEPT,    eCode: 0,         eEdge: CP_C     },
  { zWord: "case",        nChar: 4,  eType: TokenType.T_CASE,      eCode: 0,         eEdge: 0        },
  ...
  { zWord: "ease",        nChar: 4,  eType: TokenType.T_EASE,      eCode: 0,         eEdge: 0        },
  ...
  { zWord: "ending",      nChar: 6,  eType: TokenType.T_ENDING,    eCode: 0,         eEdge: 0        },
  ...
  { zWord: "fn",          nChar: 2,  eType: TokenType.T_FN,        eCode: 0,         eEdge: 0        },
  ...
  { zWord: "no",          nChar: 2,  eType: TokenType.T_NO,        eCode: 0,         eEdge: 0        },
  { zWord: "north",       nChar: 5,  eType: TokenType.T_EDGEPT,    eCode: 0,         eEdge: CP_N     },
  { zWord: "not",         nChar: 3,  eType: TokenType.T_NOT,       eCode: 0,         eEdge: 0        },
  ...
  { zWord: "starting",    nChar: 8,  eType: TokenType.T_STARTING,  eCode: 0,         eEdge: 0        },
  ...
  { zWord: "take",        nChar: 4,  eType: TokenType.T_TAKE,      eCode: 0,         eEdge: 0        },
  ...
  { zWord: "yes",         nChar: 3,  eType: TokenType.T_YES,       eCode: 0,         eEdge: 0        },
];
