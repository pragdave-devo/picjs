...
describe(`1. initial position`, () => {
  ...
  it(`is at the correct Y`, () => expect(result.y).toBe(defaultY))
  it(`is at the correct X`, () => expect(result.x).toBe(defaultX))
})
...
describe(`2. initial position with X and Y already set`, () => {
  ...
  it(`is at the correct Y`, () => expect(b.y).toBe(345))
})
...
describe(`3. second box placed to right of first by default`, () => {
  ...
  it(`Box 1 is at the correct Y`, () => expect(b1.y).toBe(defaultY))
  it(`Box 2 is at the correct X`, () => expect(b2.x).toBe(b1.x + (b2.width + b1.width) / 2))
  it(`Box 2 is at the correct Y`, () => expect(b2.y).toBe(b1.y))
})
...
describe(`4. change default direction to "down"`, () => {
  ...
  it(`Box 2 is at the correct Y`, () => expect(b2.y).toBe(b1.y + b1.height / 2 + b2.height / 2))
})
